...
export const sendMessage = async (req: Request, res: Response) => {
    ...
    Required JSON structure:
    {
      ...
      "progressIndicators": ["string"]
        ...
        const analysisResult = await genAI.models.generateContent({ model: "gemini-2.0-flash", contents: analysisPrompt });
    ...
    const responseResult = await genAI.models.generateContent({model: "gemini-2.0-flash", contents:responsePrompt});
