...
export default function TherapyPage() {
  ...
  return (
    <div className="relative max-w-7xl mx-auto px-4">
      {/* Wrapper for sidebar + chat area */}
      <div className="flex flex-col lg:flex-row h-[calc(100vh-4rem)] mt-20 gap-6">

        {/* Mobile toggle button */}
        <div className="lg:hidden flex justify-between items-center mb-2 mt-10">
          ...
          <Button
            ...
            className="hover:bg-primary/10 bg-teal-400"
          >
        ...
        <div
          className={cn(
            "fixed inset-y-0 left-0 z-30 w-72 bg-muted/30 border-r flex flex-col transform transition-transform duration-300 lg:relative lg:translate-x-0 lg:w-80",
            showSidebar ? "translate-x-0" : "-translate-x-full"
          )}
        >
          <div className="p-4 border-b flex items-center justify-between mt-1">
            <h2 className="text-lg font-semibold">Chat Sessions</h2>
            <Button
              variant="ghost"
              size="icon"
          ...
          <ScrollArea className="flex-1 p-4 z-30 bg-background mt-4 overflow-y-auto max-h-[calc(100vh-150px)]">
            {/* Header (fixed within scroll area) */}
            <div className="lg:hidden flex items-center justify-between mb-6 sticky top-0 bg-background z-40">
              <h2 className="text-lg font-semibold">Chat Sessions</h2>
              <Button
                variant="ghost"
                size="icon"
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {(() => {
                        try {
                          const date = new Date(session.startTime); // 👈 use startTime instead
        ...
        {/* Main chat area */}
        <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-background rounded-lg border md:ml-0 md:pl-0 pl-0">
          {/* Chat header */}
          <div className="p-4 border-b flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="font-semibold">MumWell Therapist</h2>
                ...
                {isTyping && (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-2">
                      <p className="font-medium text-sm">MumWell Therapist</p>
              ...
              <div className="flex-1 relative group">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    "shadow-sm shadow-primary/20 transition-all duration-200",
