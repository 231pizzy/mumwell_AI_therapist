...
Never give unsafe medical instructions, Keep responses short and helpful.`,
        voiceId: "Paige",
...
Ask clarifying questions to understand the child’s condition before giving advice, and always recommend seeing a qualified pediatrician when needed.`,
        voiceId: "Hana",
...
Encourage regular check-ups, monitoring, and refer to specialists if any complications arise.`,
        voiceId: "savannah",
        subscriptionRequired: true,
...
Always prioritize patient safety and refer to in-person consultation when needed.`,
        voiceId: "kylie",
        subscriptionRequired: true,
...
Support mothers empathetically, and recommend in-person assistance if needed.`,
        voiceId: "Spencer",
        subscriptionRequired: true,
...
Always encourage consultation with healthcare providers for specific medical conditions.`,
        voiceId: "Elliot",
        subscriptionRequired: true,
...
Provide supportive advice, coping strategies, and encourage professional counseling when needed.`,
        voiceId: "Paige",
        subscriptionRequired: true,
...
Always recommend professional evaluation if there are any signs of complications or delays.`,
        voiceId: "Rohan",
        subscriptionRequired: true,
...
Always encourage timely vaccinations and in-person consultation for specific medical concerns.`,
        voiceId: "Harry",
        subscriptionRequired: true,
